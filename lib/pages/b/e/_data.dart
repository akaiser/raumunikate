...
In Synergie zur Empfindung des Menschen bringt der Raum viele Aspekte mit, die es zu beachten gilt. Die Raumarchitektur, die Raumfunktion und die Materialität. Bewegen wir uns in großzügigen Räumen. In kleinteiligen, in hellen oder dunklen Räumen, in tradierten oder modernen, im Arbeitsraum oder im Wohnzimmer, in künstlichen Oberflächen oder natürlichen Strukturen?''',
  ...
  DesignSlideDataEntry(
    ...
    'Farbe',
    '''
Farbe flüstert, hebt hervor, harmonisiert, konzentriert, erheitert, regt an und bewegt. Farbe wirkt, als Passepartout leise im Hintergrund, als Farbkomposition im Zusammenspiel oder als Akzent laut im Vordergrund. Farbe übrlagert jede Form und Struktureigenschaft, sie ist das was wir zu erst wahrnehmen. Sie ist elementarer Bestandteil der Grundstimmung im Raum und damit der Hauptaspekt für unsere Emotionen und Gefühle.''',
    textColor: mainBackgroundColor,
  ),
];
